<template>
  <section id="ms_farmtotable" class="container">
    <div class="row justify-content-center">
      ...
      <div class="col-8">
        <div class="row">
          ...
          <div class="col-5 flex-grow-1 text-center ms_card">
          ...
          <div class="col-11 text-center text-uppercase">
            Load More Posts
          </div>
        </div>
      </div>
